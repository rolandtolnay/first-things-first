 ...
 * Rendered as a flex-1 child of the AppWindow's column.
 */
export function MainLayout({ sidebar, children, rail }: MainLayoutProps) {
  return (
    <div className="grid min-h-0 flex-1 grid-cols-[296px_1fr_304px] border-t border-border max-[1280px]:grid-cols-[296px_1fr] max-[1024px]:grid-cols-1">
