...
Plans:
- [x] 04-01: Goal CRUD operations
- [x] 04-02: Goal list UI within role sections
...
Plans:
- [x] 05.1-01: Extend drag types and make PriorityItem/EveningBlock draggable
- [x] 05.1-02: Handle cross-section drops in DndProvider
...
Plans:
- [x] 07-01: Completion state and UI feedback
